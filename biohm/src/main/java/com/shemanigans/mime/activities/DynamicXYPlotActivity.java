...
public class DynamicXYPlotActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_dca);

        // get handles to our View defined in layout.xml:
        dynamicPlot = (XYPlot) findViewById(R.id.bioimpedancePlot);

        final MyPlotUpdater plotUpdater = new MyPlotUpdater(dynamicPlot);
    ...
    static class MyPlotUpdater implements Observer {
        Plot plot;
    ...
    static class SampleDynamicXYDatasource implements Runnable {
